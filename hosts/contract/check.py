#!/usr/bin/env python3
"""Checks one run of fake_core.py inside a host: what the host answered (report.json) and the
recording itself (part01.mp4), against docs/HOST.md. Usage: check.py <out dir> <host name>."""
...
print(f"PASS: the {host} host keeps the contract and records a clean file")
