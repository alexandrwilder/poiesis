#!/usr/bin/env python3
"""The core's side of docs/HOST.md, played inside the Mac host in place of the real core:
meet, show the picture with a look, record five seconds, stop, rest the picture. What the
host answered goes to a JSON report; test.sh checks the report and the recording."""
import json
import os
import socket
import sys
